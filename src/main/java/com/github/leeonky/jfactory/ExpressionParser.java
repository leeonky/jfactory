...
class ExpressionParser<T> {
    ...
    private PropertyExpression<T> create(Object value) {
        ...
        if (index != null)
            propertyExpression = new CollectionPropertyExpression<>(Integer.valueOf(index), propertyExpression, property, beanClass, property);
        return propertyExpression;
    }

    private PropertyExpression<T> create(Object value, String[] mixIn, String definition, String condition, String property, BeanClass<T> beanClass, String field) {
