...
public class _08_TypeReference {
    ...
    class ByType {
        ...
        class SingleClass {
            ...
            void support_create_java_class_by_type_reference() {
                expect(jFactory.type(new TypeReference<Bean>() {
                }).create()).should("class.simpleName: 'Bean'");
            }
        }
    ...
    class BySpec {
        ...
        class SingleClass {
            ...
            @Test
            void type_reference_with_spec() {
                expect(jFactory.spec(new SpecReference<Bean>(BeanSpec.class) {
                }).create()).should("class.simpleName: 'Bean'");
            }
        }
